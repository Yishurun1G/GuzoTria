    ...
    <section>
      <div className="w-[90%] mx-auto text-white">
        <div className="my-[5rem] text-center">
          ...
          <p className="text-xl w-[43%] mx-auto">Download the Guzo app today to unlock, ride, and park with ultimate convenience.</p>
        </div>

        <div className="flex items-center justify-around mb-[7rem] text-white">
          <div className="flex items-center justify-center bg-red-700 text-4xl w-[20rem] h-[30rem]">Temporary</div>
          <div className="flex items-center justify-center bg-red-700 text-4xl w-[20rem] h-[30rem]">Temporary</div>
          <div className="flex items-center justify-center bg-red-700 text-4xl w-[20rem] h-[30rem]">Temporary</div>
        </div>
